...
RSpec.describe "proprietaires/new", :type => :view do
  ...
  it "renders new proprietaire form" do
    ...
    assert_select "form[action=?][method=?]", proprietaires_path, "post" do
      ...
      assert_select "input#proprietaire_principal_groupe_id[name=?]", "proprietaire[principal_groupe_id]"

      assert_select "input#proprietaire_sous_groupe_id[name=?]", "proprietaire[sous_groupe_id]"
